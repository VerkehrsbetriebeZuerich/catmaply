...
How about illustrating differences in one category? You can illustrate values that are particularly low (high) within one category by specifying one colorbar per category. 
